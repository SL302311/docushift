/// DocuShift PDF 转 PNG — MethodChannel 合约定义（第 4 期）。
///
...
/// 通道名称。
const String kChannelName = 'com.example.docushift_mobile/pdf_to_png';
...
/// 将 PDF 全部页面按页序渲染为 PNG 写入新建输出子文件夹。
///
/// 参数：
...
const String kMethodConvertPdfToPng = 'convertPdfToPng';
...
/// 页数键（pickPdf 与 convertPdfToPng 返回）。
const String kResultPageCount = 'pageCount';

/// 字节数键（pickPdf 返回文件大小；convertPdfToPng 返回 PNG 总字节数）。
const String kResultSize = 'size';

/// convertPdfToPng 返回的输出目录 URI 键。
